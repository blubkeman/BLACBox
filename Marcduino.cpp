...
Marcduino::Marcduino(Controller_PS5 * pController)
...
// ===============================
bool Marcduino::isCustomPanelRunning(void) { return m_cprRunning; }
...
{
  if ( panelNumber > NUMBER_OF_BODY_PANELS ) { return; }
...
{
  if ( panelNumber > NUMBER_OF_DOME_PANELS ) { return; }
...
{
  if ( hpNumber > NUMBER_OF_HOLOPROJECTORS ) { return; }
...
void Marcduino::m_runSequence(uint8_t sequenceNumber)
{
  ...
  #if defined(MD_BODY_SOUND)
  switch (sequenceNumber) {
    case 1 : { m_soundScream();       break; }  // Scream
    case 2 : {                        break; }  // Wave
    case 3 : {                        break; }  // Fast Smirk
    case 4 : {                        break; }  // Wave 2
    case 5 : { m_soundShortCantina(); break; }  // Beep Cantina
    case 6 : { m_soundFaint();        break; }  // Faint/Short Circuit
    case 7 : { m_soundLongCantina();  break; }  // Cantina dance
    case 8 : { m_soundLeia();         break; }  // Leia
    case 9 : { m_soundDisco();        break; }  // Disco
  ...
  #endif  // if defined(MD_BODY_SOUND)
  #endif  // if defined(MD_BODY_MASTER)
}
